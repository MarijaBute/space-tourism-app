...
export default function Header() {
    return (
        <header>
            <svg className="site-logo-svg" width="100%" height="1" viewBox="0 0 100% 1" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
                <rect opacity="0.251485" width="35%" height="1" fill="white" />
            </svg>
